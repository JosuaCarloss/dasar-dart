...
void main() {
  ...
  print(nama.contains('josua carlos')); //keluarannya adalah true

  //untuk mengubah menjadi huruf kecil semua
  print(nama.toLowerCase()); //keluarannya adalah josua carlos

  //untuk mengubah menjadi huruf besar semua
  print(nama.toUpperCase()); //keluarannya adalah josua carlos

  //untuk memilih kata tertentu yang ingin ditampilkan dengan menggunakan index
  print(nama.substring(5)); //keluarannya adalah  josua carlos
  ...
  /* Misalnya : */
  String name = ' josua carlos  ';
  print(name.trim()); //keluarannya = josua carlos 
